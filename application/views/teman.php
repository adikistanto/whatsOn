				...
				<div id="col2" class="col-md-6">
					<div id="tab" class="col-md-6">
						...
						<div id="tab_status" class="col-md-4">
							<span class="tab_text">Friends</span>
						</div>
					</div>
					...
					<div style="margin-right: 15px" class="col-md-5 status">
						<div id="status_title" class="col-md-12">
                                                    ...
                                                    <div style="float:right" class="icon col-md-10">Friend 2</div>
						...
						<div id="status_title" class="col-md-12">
                                                    ...
                                                    <div style="float:right" class="icon col-md-10">Friend 3</div>
						...
						<div id="status_title" class="col-md-12">
                                                    ...
                                                    <div style="float:right" class="icon col-md-10">Friend 4</div>
						...
						<div id="status_title" class="col-md-12">
                                                    ...
                                                    <div style="float:right" class="icon col-md-10">Friend 5</div>
						...
						<div id="status_title" class="col-md-12">
                                                    ...
                                                    <div style="float:right" class="icon col-md-10">Friend 6</div>
